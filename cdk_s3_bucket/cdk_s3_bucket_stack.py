...
class CdkS3BucketStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Create an S3 bucket
        bucket = s3.Bucket(self, "demo-cdk-code-catalyst-abhishek88867",  # Changed from XXXXXXXXXXXXX to a meaningful ID
            # Optional configurations
            bucket_name="testing-test-doc-bukall88867",  # Changed from XXXXXXXXXXXXX to a meaningful name
